...
Feature: Business activity within UK EQs
  ...
  Scenario: 1 - User navigates to next eligibility question page
    ...
    And The caption should be Check if this group needs to register
    And The Heading should be Does any entity in this group have business activity in the UK?
  ...
  Scenario: 2 - User navigates to guidance page
    Given I am on Business activity EQ Page
    And The caption should be Check if this group needs to register
    And The Body content should be Does any entity in this group have business activity in the UK?
    When I choose No and continue
    Then I should navigate to BA guidance page
    And The Heading should be Based on your answers, this group does not need to register for Global Minimum Tax
    And The Body content should be Global Minimum Tax may be collected in the UK when you have business activity here.
