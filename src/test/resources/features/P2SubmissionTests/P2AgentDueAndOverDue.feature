...
Feature: Pillar2 Due & Overdue returns And Submission History User Journey
  ...
  Scenario: 1 - Agent User navigates to Due & Overdue returns and Submission History for multiple accounting period
  ...
  Scenario: 2 - Agent User navigates to Due & Overdue returns and Submission History pages for no accounting period
    Given Agent User logs in with existing entity group HMRC-AS-AGENT, AgentReference and 1234 for Pillar2 service
  ...
  Scenario: 3 - Agent User navigates to Due & Overdue returns and Submission History pages for single accounting period
    Given Agent User logs in with existing entity group HMRC-AS-AGENT, AgentReference and 1234 for Pillar2 service
  ...
  Scenario: 4 - Agent User navigates to Due & Overdue returns and Submission History pages for all fulfilled submissions
    Given Agent User logs in with existing entity group HMRC-AS-AGENT, AgentReference and 1234 for Pillar2 service
  ...
  Scenario: 5 - Agent User navigates to Due & Overdue returns and Submission History pages for some fulfilled submissions
    Given Agent User logs in with existing entity group HMRC-AS-AGENT, AgentReference and 1234 for Pillar2 service
