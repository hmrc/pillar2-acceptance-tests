...
Feature: UPE NO ID journey
  ...
  Scenario: 3 - Validate different error messages for UPE no ID journey pages
    ...
    Then I should see address error message Enter a full UK post code on the Postal code Element
    ...
    Then I should see address error message Postal code must be 10 characters or less on the Postal code Element
    When I enter Address Line 1 as Test Address Line 1
