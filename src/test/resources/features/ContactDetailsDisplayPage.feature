...
Feature: Contact details guidance and logic to play back contact details
  ...
  Scenario: 1 - Create a new subscription with NFM No Id flow for validating play back contact details
    ...
    And I should see the contact details row 1 as NFM Test on use contact page
    And I should see the contact details row 2 as testNFM@email.com on use contact page
    And I should see the contact details row 3 as 12345678 on use contact page
    When I select option No and continue to next
