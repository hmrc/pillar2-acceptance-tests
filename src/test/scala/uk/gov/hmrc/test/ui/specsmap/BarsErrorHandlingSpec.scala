  ...
  Feature("Bars Handling") {
    ...
    Scenario("1 - Organisation User bars integration validation") {
      ...
      When("I provide value for Refund Reason as Bars Integration Test")
        andIProvideValueForXAsX("Refund Reason", "Bars Integration Test")  // auto-chosen (score=1.00, PaymentStepsSteps.scala)
      ...
      When("I select option Yes on partial name error page")
        andISelectOptionXOnPartialNameErrorPage("Yes")  // auto-chosen (score=1.00, PaymentStepsSteps.scala)
      ...
      And("I select option No on partial name error page")
        andISelectOptionXOnPartialNameErrorPage("No")  // auto-chosen (score=1.00, PaymentStepsSteps.scala)
