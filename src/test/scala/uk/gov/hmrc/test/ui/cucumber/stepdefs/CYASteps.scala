...
import uk.gov.hmrc.test.ui.scalaPages._
...
object CYASteps {
  ...
  def andIShouldSeeRowdValueX(row: Int, value: String): Unit = {
  ...
  def andIShouldSeeRowdWithKeyXAndValueX(row: Int, key: String, value: String): Unit = {
