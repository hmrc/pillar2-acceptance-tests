...
trait CommonFunctions
  ...
  def pageMatch(page: String): PageObject = {
    page match {
      ...
      case "Contact details Check answers page" =>
        ContactDetailsCheckAnswersPage
      ...
      case "Contact details change telephone page" =>
        ContactDetailsChangeTelephonePage
      case "Contact details input telephone page"  =>
        ContactDetailsInputTelephonePage
      ...
      case "UPE registration failed error page" =>
        UPEGRSRegistrationFailedErrorPage
      case "UPE registration not called error page" =>
        UPEGRSRegistrationNotCalledErrorPage
      case "search register page"                   => SearchRegisterPage
      case "Corporation Tax UTR page"               => CorporationTaxUTRPage
      case "NFM registration failed error page"     =>
        NFMGRSRegistrationFailedErrorPage
      case "NFM registration not called error page" =>
        NFMGRSRegistrationNotCalledErrorPage
      ...
      case "Incomplete Data Submission Error Page" =>
        IncompleteDataSubmissionErrorPage
      ...
      case "RFM New NFM Contact Address Page"      =>
        RFMNewNFMContactAddressInputPage
      ...
      case "RFM second contact telephone question page" =>
        RFMSecondContactTelephoneQuestionPage
      ...
      case "RFM GRS Registration Not Called Error Page" =>
        RFMGRSRegistrationNotCalledErrorPage
      case "RFM GRS Registration Mismatch Error Page"   =>
      ...
      case "Change Non UK Bank Account Payment Page" =>
        ChangeNonUKBankAccountPaymentPage
      case "UK Bank Account Payment Page"            => UKBankAccountPaymentPage
      case "Change UK Bank Account Payment Page"     =>
        ChangeUKBankAccountPaymentPage
      ...
      case "Repayment Could Not Confirm Error Page" =>
        RepaymentCouldNotConfirmErrorPage
      ...
      case "Repayment Journey Recovery Error Page" =>
        RepaymentJourneyRecoveryErrorPage
