...
trait CommonFunctions
  ...
  def pageMatch(page: String): PageObject = {
    page match {
      ...
      case "Create Subscription Error page"       => CreateSubErrorPage
    }
  }
}
