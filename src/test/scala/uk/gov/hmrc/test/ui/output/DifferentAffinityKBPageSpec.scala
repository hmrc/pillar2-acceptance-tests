  ...
  Feature("Failure scenarios with different Affinity groups") {
    ...
    Scenario("1 - User logins as organisation user and standard role") {
      Given("Assistant User logs in to register for Pillar2")
        // ⚠️ No step-def match found for: Assistant User logs in to register for Pillar2

      Then("I should be on Assistant role KB page")
        // ⚠️ No step-def match found for: I should be on Assistant role KB page
      ...
      Then("I should navigate to Assistant role KB page")
        // ⚠️ No step-def match found for: I should navigate to Assistant role KB page
    ...
    Scenario("2 - User logins as Agent") {
      Given("Agent User logs in to register for Pillar2")
        // ⚠️ No step-def match found for: Agent User logs in to register for Pillar2

      Then("I should be on Agent affinity KB page")
        // ⚠️ No step-def match found for: I should be on Agent affinity KB page
      ...
      When("I click request authorisation via agent services link")
        // ⚠️ No step-def match found for: I click request authorisation via agent services link
      ...
      Then("I should navigate to Agent affinity KB page")
        // ⚠️ No step-def match found for: I should navigate to Agent affinity KB page
    ...
    Scenario("3 - User logins as Individual User") {
      Given("Individual User logs in to register for Pillar2")
        // ⚠️ No step-def match found for: Individual User logs in to register for Pillar2

      Then("I should be on Individual affinity KB page")
        // ⚠️ No step-def match found for: I should be on Individual affinity KB page
      ...
      Then("I should navigate to Individual affinity KB page")
        // ⚠️ No step-def match found for: I should navigate to Individual affinity KB page
