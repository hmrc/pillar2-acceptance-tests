...
class BTNUnsuccessfulSpec extends BaseSpec with Matchers {
  ...
  Feature("Below threshold notification unauthorised user journeys") {
    ...
    Scenario("1 - Org User navigates to KB page, if BTN submission unsuccessful [PLRID=XEPLR4220000000]", Tests) {
    ...
    Scenario("2 - Org User navigates to KB page, if BTN submission unsuccessful [PLRID=XEPLR4000000000]", Tests) {
    ...
    Scenario("3 - Org User navigates to KB page, if BTN submission unsuccessful [PLRID=XEPLR5000000000]", Tests) {
