  ...
  Feature("RFM check your answers page") {
    ...
    Scenario("1 - Verify Journey recovery page and error handling on submission of Pillar id and registration date for RFM journey") {
      ...
      When("I provide RFM pillar2 id as XEPLR0123456400")
        // ⚠️ No step-def match found for: I provide RFM pillar2 id as XEPLR0123456400
      ...
      Then("I should navigate to RFM journey recovery page")
        // ⚠️ No step-def match found for: I should navigate to RFM journey recovery page
      ...
      And("I provide RFM pillar2 id as XEPLR0123456222")
        // ⚠️ No step-def match found for: I provide RFM pillar2 id as XEPLR0123456222

      Then("I should be on RFM Registration Date Page")
        // ⚠️ No step-def match found for: I should be on RFM Registration Date Page

      When("Registration Day is entered as 27")
        // ⚠️ No step-def match found for: Registration Day is entered as 27
      ...
      Then("I should navigate to RFM No record Match Error Page")
        // ⚠️ No step-def match found for: I should navigate to RFM No record Match Error Page
      ...
      When("I click change link for RFM Pillar 2 Top-up Taxes ID")
        // ⚠️ No step-def match found for: I click change link for RFM Pillar 2 Top-up Taxes ID

      And("I provide RFM pillar2 id as XEPLR0123456404")
        // ⚠️ No step-def match found for: I provide RFM pillar2 id as XEPLR0123456404
      ...
      And("I click go back to try again using different details. link")
        // ⚠️ No step-def match found for: I click go back to try again using different details. link
      ...
      And("I provide RFM pillar2 id as XMPLR0123456111")
        // ⚠️ No step-def match found for: I provide RFM pillar2 id as XMPLR0123456111
    ...
    Scenario("2 - Verify that system throws an error on generic failure from ETMP when calling Amend API in replacing rfm journey") {
      ...
      When("I provide RFM pillar2 id as XMPLR0012345111")
        // ⚠️ No step-def match found for: I provide RFM pillar2 id as XMPLR0012345111
      ...
      When("I provide RFM contact name as 500")
        // ⚠️ No step-def match found for: I provide RFM contact name as 500
    ...
    Scenario("3 - Verify Incomplete data error") {
      ...
      And("I continue to RFM contact name Page")
        // ⚠️ No step-def match found for: I continue to RFM contact name Page
      ...
      When("I click change link for RFM Change Second Contact Preference")
        // ⚠️ No step-def match found for: I click change link for RFM Change Second Contact Preference
      ...
      Then("I should navigate to RFM incomplete task error page")
        // ⚠️ No step-def match found for: I should navigate to RFM incomplete task error page

      When("I click replace the filing member for a Pillar 2 Top-up Taxes account to try again link")
        // ⚠️ No step-def match found for: I click replace the filing member for a Pillar 2 Top-up Taxes account to try again link

      Then("I should be on RFM Final Review Page")
        // ⚠️ No step-def match found for: I should be on RFM Final Review Page
    ...
    Scenario("4 - Verify Security questions are not pre populated for RFM journey") {
      Given("Organisation User logs in to RFM with credId RFMSaveProgress for Pillar2")
        // ⚠️ No step-def match found for: Organisation User logs in to RFM with credId RFMSaveProgress for Pillar2
