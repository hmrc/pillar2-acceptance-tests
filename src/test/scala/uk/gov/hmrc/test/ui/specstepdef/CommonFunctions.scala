...
//      case "NFM details page"                           => NFMRegisteredInUkPage
...
//      case "Group accounting period page"               => FDGroupAccountingPeriodPage
//      case "FD check your answers page"                 => FDCheckYourAnswersPage
...
//      case "Contact details phone page"                 => ContactDetailsPhoneAsContactPage
