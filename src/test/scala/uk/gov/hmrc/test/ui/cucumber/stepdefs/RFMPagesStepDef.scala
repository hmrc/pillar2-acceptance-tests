...
class RFMPagesStepDef extends BaseStepDef with BrowserDriver {
  ...
  And("""^I should see RFM field (.*) is pre-populated with (.*)$""") {
    (field: String, name: String) =>
      field match {
        case "pillar2 id" =>
          assert(
            getAttributeOf(RFMEnterPillar2IdPage.pillar2topuptaxid, "value")
              .equals(name)
          )
      }
  }

  And("""^I should see RFM date field (.*) is pre-populated with (.*)$""") {
    (field: String, name: String) =>
      field match {
        case "Start Day" =>
          assert(
            getAttributeOfId(RFMRegistrationDatePage.regDay, "value").equals(
              name
            )
          )
        ...
        case "Start Month" =>
          assert(
            getAttributeOfId(RFMRegistrationDatePage.regMonth, "value").equals(
              name
            )
          )
        ...
        case "Start Year" =>
          assert(
            getAttributeOfId(RFMRegistrationDatePage.regYear, "value").equals(
              name
            )
          )
      }
  ...
  And("""^I should see the corporate position (.*) remain selected$""") {
    (answer: String) =>
    ...
    field match {
      case "pillar2 id" =>
        ...
        Wait.waitForElementToPresentByCssSelector(
          RFMEnterPillar2IdPage.pillar2topuptaxid
        )
      ...
      case "contact name" =>
        Wait.waitForTagNameToBeRefreshed("h1")
        Wait.waitForElementToPresentByCssSelector(
          RFMContactDetailNamePage.nameField
        )
      ...
      case "contact email" =>
        Wait.waitForTagNameToBeRefreshed("h1")
        Wait.waitForElementToPresentByCssSelector(
          RFMContactEmailPage.emailField
        )
      ...
      case "contact number" =>
        Wait.waitForTagNameToBeRefreshed("h1")
        Wait.waitForElementToPresentByCssSelector(
          RFMContactInputPage.telephoneField
        )
      ...
      case "New NFM Name" =>
        Wait.waitForTagNameToBeRefreshed("h1")
        Wait.waitForElementToPresentByCssSelector(
          RFMNewNFMContactNamePage.nameField
        )
      ...
      case "second contact number" =>
        Wait.waitForTagNameToBeRefreshed("h1")
        Wait.waitForElementToPresentByCssSelector(
          RFMSecondContactTelephonePage.telephoneField
        )
  ...
  And("""^I should see an error message (.*) on the RFM (.*) Page$""") {
    (error: String, page: String) =>
      page match {
        case "start" =>
          ...
          Wait.waitForElementToPresentByCssSelector(RFMStartPage.errorMessage)
          getTextOf(By cssSelector (RFMStartPage.errorMessage)) should include(
            error
          )
        ...
        case "enter pillar2 id" =>
          Wait.waitForTagNameToBeRefreshed("h1")
          Wait.waitForElementToPresentByCssSelector(
            RFMEnterPillar2IdPage.errorMessage
          )

          Wait.waitForElementToPresentByCssSelector(
            RFMEnterPillar2IdPage.errorLink
          )
          getTextOf(By cssSelector (RFMEnterPillar2IdPage.errorLink)) should be(
            error
          )
          ...
          getTextOf(
            By cssSelector (RFMEnterPillar2IdPage.errorMessage)
          ) should include(error)

        case "Registration Date" =>
          Wait.waitForTagNameToBeRefreshed("h1")
          Wait.waitForElementToPresentByCssSelector(
            RFMRegistrationDatePage.errorMessage
          )

          Wait.waitForElementToPresentByCssSelector(
            RFMRegistrationDatePage.errorLink
          )
          getTextOf(
            By cssSelector (RFMRegistrationDatePage.errorLink)
          ) should be(error)
          ...
          getTextOf(
            By cssSelector (RFMRegistrationDatePage.errorMessage)
          ) should include(error)

        case "journey error" =>
          Wait.waitForTagNameToBeRefreshed("h1")
          Wait.waitForElementToPresentByCssSelector(
            RFMCorpPositionPage.errorMessage
          )

          Wait.waitForElementToPresentByCssSelector(
            RFMCorpPositionPage.errorLink
          )
          getTextOf(By cssSelector (RFMCorpPositionPage.errorLink)) should be(
            error
          )
          ...
          getTextOf(
            By cssSelector (RFMCorpPositionPage.errorMessage)
          ) should include(error)

        case "contact detail" =>
          Wait.waitForTagNameToBeRefreshed("h1")
          Wait.waitForElementToPresentByCssSelector(
            RFMContactDetailNamePage.errorMessage
          )

          Wait.waitForElementToPresentByCssSelector(
            RFMContactDetailNamePage.errorLink
          )
          getTextOf(
            By cssSelector (RFMContactDetailNamePage.errorLink)
          ) should be(error)
          ...
          getTextOf(
            By cssSelector (RFMContactDetailNamePage.errorMessage)
          ) should include(error)

        case "contact name" =>
          Wait.waitForTagNameToBeRefreshed("h1")
          Wait.waitForElementToPresentByCssSelector(
            RFMNewNFMContactNamePage.errorMessage
          )

          Wait.waitForElementToPresentByCssSelector(
            RFMNewNFMContactNamePage.errorLink
          )
          getTextOf(
            By cssSelector (RFMNewNFMContactNamePage.errorLink)
          ) should be(error)
          ...
          getTextOf(
            By cssSelector (RFMNewNFMContactNamePage.errorMessage)
          ) should include(error)

        case "second contact name" =>
          Wait.waitForTagNameToBeRefreshed("h1")
          Wait.waitForElementToPresentByCssSelector(
            RFMSecondContactNamePage.errorMessage
          )

          Wait.waitForElementToPresentByCssSelector(
            RFMSecondContactNamePage.errorLink
          )
          getTextOf(
            By cssSelector (RFMSecondContactNamePage.errorLink)
          ) should be(error)
          ...
          getTextOf(
            By cssSelector (RFMSecondContactNamePage.errorMessage)
          ) should include(error)

        case "contact address change" =>
          Wait.waitForTagNameToBeRefreshed("h1")
          Wait.waitForElementToPresentByCssSelector(
            RFMNewNFMContactAddressChange.errorMessage
          )

          Wait.waitForElementToPresentByCssSelector(
            RFMNewNFMContactAddressChange.errorLink
          )
          getTextOf(
            By cssSelector (RFMNewNFMContactAddressChange.errorLink)
          ) should be(error)
          ...
          getTextOf(
            By cssSelector (RFMNewNFMContactAddressChange.errorMessage)
          ) should include(error)

        case "contact email" =>
          Wait.waitForTagNameToBeRefreshed("h1")
          Wait.waitForElementToPresentByCssSelector(
            RFMSecondContactEmailPage.errorMessage
          )

          Wait.waitForElementToPresentByCssSelector(
            RFMSecondContactEmailPage.errorLink
          )
          getTextOf(
            By cssSelector (RFMSecondContactEmailPage.errorLink)
          ) should be(error)
          ...
          getTextOf(
            By cssSelector (RFMSecondContactEmailPage.errorMessage)
          ) should include(error)

        case "input telephone" =>
          Wait.waitForTagNameToBeRefreshed("h1")
          Wait.waitForElementToPresentByCssSelector(
            RFMSecondContactTelephoneQuestionPage.errorMessage
          )

          Wait.waitForElementToPresentByCssSelector(
            RFMSecondContactTelephoneQuestionPage.errorLink
          )
          getTextOf(
            By cssSelector (RFMSecondContactTelephoneQuestionPage.errorLink)
          ) should be(error)
          ...
          getTextOf(
            By cssSelector (RFMSecondContactTelephoneQuestionPage.errorMessage)
          ) should include(error)
      }
  }

  And("""^Registration (.*) is entered as (.*)$""") {
    (field: String, name: String) =>
      field match {
        case "Day" =>
          Wait.waitForTagNameToBeRefreshed("h1")
  ...
  When("""I enter future date""") { () =>
    ...
    Input.sendKeysById(
      RFMRegistrationDatePage.regDay,
      futureDate.getDayOfMonth.toString
    )
    Input.sendKeysById(
      RFMRegistrationDatePage.regMonth,
      futureDate.getMonthValue.toString
    )
    Input.sendKeysById(
      RFMRegistrationDatePage.regYear,
  ...
  When(
    ...
    AuthLoginPage.loginWithExistingEntityWithRFM(
      enrolmentkey,
      identifiername,
      identifiervalue
    )
  ...
  And("""^I should see 4 sections on RFM start page""") { () =>
    ...
    assert(
      driver.findElements(By.cssSelector(RFMStartPage.sections)).size() == 4
    )
  }

  And("""^I should see the section (\d+) as (.*)""") {
    (sectionNumber: Int, sectionName: String) =>
      assert(
        driver
          .findElements(By.cssSelector(RFMStartPage.sections))
          .get(sectionNumber - 1)
          .getText
  ...
  And("""^I should see the row (\d+) value (.*)$""") {
    (row: Int, value: String) =>
      Wait.waitForTagNameToBeRefreshed("h1")
      assert(
        driver
          .findElements(By.cssSelector(RFMFinalReviewCYAPage.valueList))
          .get(row - 1)
          .getText
          .contains(value)
      )
  ...
  Given("""^(.*) logs in to RFM with credId (.*) for Pillar2""") {
    (name: String, credId: String) =>
      name match {
        case "Organisation User" =>
          AuthLoginPage.loginWithUserToRFMWithCredId(name, credId)
    ...
    value match {
      case "Pillar2 Id" =>
        ...
        assert(
          driver
            .findElement(
              By.cssSelector(RFMEnterPillar2IdPage.pillar2topuptaxid)
            )
            .getAttribute("value")
            .isEmpty()
        )
      ...
      case "Registration Day" =>
        ...
        assert(
          driver
            .findElement(By.id(RFMRegistrationDatePage.regDay))
            .getAttribute("value")
            .isEmpty()
        )
      ...
      case "Registration Month" =>
        ...
        assert(
          driver
            .findElement(By.id(RFMRegistrationDatePage.regMonth))
            .getAttribute("value")
            .isEmpty()
        )
      ...
      case "Registration Year" =>
        ...
        assert(
          driver
            .findElement(By.id(RFMRegistrationDatePage.regYear))
            .getAttribute("value")
            .isEmpty()
        )
    }
  ...
  Then("""^I should see (.*) text is not clickable""") { (linkText: String) =>
    Wait.waitForCSSElementNotToPresent(
      "[href='report-pillar2-top-up-taxes/banner']"
    )
  }
