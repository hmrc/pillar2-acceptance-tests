...
object RFMSteps extends CommonFunctions{
  ...
  def andIShouldSeeTheRowXValueX(row: Int, value: String): Unit = {
    Wait.waitForTagNameToBeRefreshed("h1")
...
//  }
  ...
  def thenIShouldBeRedirectedToXOrX(page1: String, page2: String): Unit = {
