...
final case class SubscriptionDataResponse(
...
object SubscriptionDataResponse {

  implicit val format: OFormat[SubscriptionDataResponse] = Json.format[SubscriptionDataResponse]
}

final case class SubscriptionSuccess(success: SubscriptionDataResponse)
